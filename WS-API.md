...
> Проверка кода ошибки, возвразаемого в ответ на посылаемое серверу сообщение, при code=0, гарантирует что сообщение принято сервером в обработку
...
* **data** - Полезные данные
  ...
  * **sender_id** - Уникальный идентификатор пользователя получателя запроса
